...
const Sidebar = ({ isOpen, onClose }) => {
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-screen w-[60vw] lg:w-[17vw] overflow-hidden bg-white text-black transition-transform duration-300 transform ${
        isOpen ? 'translate-x-0' : '-translate-x-full'
      } border-r border-button border-solid rounded-r-[45px]`}
    >
      <div className="p-4 mb-3">
        <div onClick={toggleSidebar} className='lg:w-[20vw] flex ml-5 mt-5 items-center'>
